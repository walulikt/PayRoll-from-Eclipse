...
// Obliczenia wyp�aty dla urz�dnika:	
	...
	double roundOfficialPaayroll = 0;
		...
		public void officialPrintInfo () {
			System.out.println("Wysoko�� wyp�aty" + getFirstName()+" " +getLastName()+ " wynosi: " + roundOfficialPaayroll);
		}
// Obliczenia wyp��ty dla robotnika:	
	...
	private double hoursLimit=42;
		...
		public void workerPrintInfo () {
			System.out.println("Wysoko�� wyp�aty" + getFirstName()+" " +getLastName()+ " wynosi: " + workerPeyroll);
		}
